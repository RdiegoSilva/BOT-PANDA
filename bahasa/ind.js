...
exports.noregis = () => {
	return`〘 🐼𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐄-𝐒𝐄 𝐏𝐑𝐈𝐌𝐄𝐈𝐑𝐎🐼 〙\n\n𝐂𝐎𝐌𝐎 𝐒𝐄-𝐑𝐄𝐆𝐈𝐒𝐓𝐀𝐑 ${prefix}\n𝐝𝐚𝐟𝐭𝐚𝐫 𝐍𝐨𝐦𝐞|𝐢𝐝𝐚𝐝𝐞 \n𝐄𝐱𝐞𝐦𝐩𝐥𝐨: ${prefix}𝐝𝐚𝐟𝐭𝐚𝐫 𝐏𝐚𝐧𝐝𝐚|𝟏𝟖`
}

exports.rediregis = () => {
	return`〘 🐼𝐉𝐀 𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐀𝐃𝐎🐼 〙\n\n*Você já Está Registrado No Banco De Dados Do Bot Panda*`
}
...
exports.bug = () => {
	return`*Problemas foram relatados ao proprietário Diego, relatórios falsos ou confusos não serão respondidos.*`
}
